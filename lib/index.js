...
function sheet_from_array_of_arrays(data) {
  ...
  for (var R = 0; R != data.length; ++R) {
    for (var C = 0; C != data[R].length; ++C) {
      ...
      if (isNaN(cell.v) === false) cell.t = 'n';else if (typeof cell.v === 'boolean') cell.t = 'b';else if (isNaN(Date.parse(cell.v)) === false && cell.v.indexOf('***') === -1) {
        cell.t = 'd';
      } else cell.t = 's';
...
var Column = exports.Column = function (_Component) {
  ...
  _createClass(Column, [{
    ...
    value: function render() {
      return '<Column/> is not meant to be rendered.';
...
var Sheet = exports.Sheet = function (_Component2) {
  ...
  _createClass(Sheet, [{
    key: 'render',
    value: function render() {
      return '<Sheet/> is not meant to be rendered.';
    } // eslint-disable-line react/require-render-return
